...
\begin{figure}[h]
	\includegraphics[width=4.5cm, height=3cm]{Noise_ORL_Normal_Comparison.png}
	\includegraphics[width=4.5cm, height=3cm]{Noise_ORL_Poisson_Comparison.png}
	\includegraphics[width=4.5cm, height=3cm]{Noise_ORL_Salt_and_Pepper_Comparison.png}
